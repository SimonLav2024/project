...
const About = ({ onSetActive }: AboutProps) => {
  ...
  const texts = {
    ...
    intro2: language === 'es'
      ? 'Tengo un marcado enfoque en código limpio, diseño responsivo y optimización de rendimiento, busco construir sitios y aplicaciones que destaquen en el competitivo entorno digital actual no solo por su diseño atractivo sino por su facilidad de cara al usuario. Creo en el aprendizaje continuo y en mantenerme actualizado con las últimas tecnologías y tendencias de diseño y desarrollo web.'
